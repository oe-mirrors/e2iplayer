...
class TrailersApple(CBaseHostClass):
    ...
    def listMain(self, cItem):
        ...
        MAIN_CAT_TAB = [{'category': 'list_items', 'title': 'Just Added', 'url': self.getFullUrl('/trailers/home/feeds/just_added.json')},
                        ...
                        {'category': 'list_items', 'title': 'Movie Studios', 'url': self.getFullUrl('/trailers/home/feeds/studios.json')}] + self.searchItems()
    ...
    def listSearchResult(self, cItem, searchPattern, searchType):
        url = self.getFullUrl('/trailers/home/scripts/quickfind.php?q=%s') % urllib_quote_plus(searchPattern)
