...
import re
from Plugins.Extensions.IPTVPlayer.libs.youtube_dl.utils import unescapeHTML, url_basename
...
class HEADRequest(compat_urllib_request):
	def get_method(self):
		return "HEAD"
...
class MTVServicesInfoExtractor(InfoExtractor):
	...
	def _extract_video_formats(self, mdoc, mtvn_id):
		if re.match(r'.*/(error_country_block\.swf|geoblock\.mp4)$', self.xmlGetText(mdoc, 'src')) is not None:
			...
			raise ValueError('This video is not available from your country.')
