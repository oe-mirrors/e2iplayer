...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries']  = ['appletrailers','efilmytv','alltubetv','ekinotv','cdapl','iitvpl','videopenny','zalukajcom','serialnet','freediscpl', \
                                                     ...
                                                     'cinemaxx','hd1080online','kkiste','altadefinizione1', 'altadefinizionecool','lookmovieag','cb01']
        ...
        self.PREDEFINED_HOSTS['italian']          = ['youtube','mediasetplay','filmpertutti','altadefinizione01','tantifilmorg','filmstreamhdit','dailymotion','vimeo','twitchtv','hitboxtv','playrtsiw','altadefinizione','streaminghdfun', \
                                                     'guardaserie','raiplay','dplayit','la7it', 'pmgsport','sportitalia','altadefinizione1','altadefinizionecool', 'cineblog', 'dsda','cb01']
