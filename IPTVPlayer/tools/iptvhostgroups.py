...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries'] = ['seezsu', 'ekinotv', 'cdapl', 'zaluknijcc', 'filman', 'obejrzyjto', 'ogladajto', 'filmowoclub', 'freediscpl',
                                                     ...
                                                     'cinemay', 'icefilmsinfo', 'egybest', 'librestream', 'streamcomplet', 'skstream', 'filmstreamvkcom',
                                                     ...
                                                     'altadefinizione01', '123movieshd', 'guardaserie', 'filma24io', 'ddl', 'hdfull', 'dixmax', 'plusdede', 'fenixsite',
        ...
        self.PREDEFINED_HOSTS['italian'] = ['youtube', 'mediasetplay', 'altadefinizione01', 'tantifilmorg', 'dailymotion', 'vimeo', 'twitchtv', 'playrtsiw', 'guardaserie', 'raiplay']
