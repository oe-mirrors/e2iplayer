...
class IPTVHostsGroups:
    def __init__(self):
        ...
        self.PREDEFINED_HOSTS['moviesandseries']  = ['appletrailers','3filmy','efilmytv','alltubetv','ekinomaniak','ekinotv','cdapl','iitvpl','ogladajto','govodtv','filmynadzis','freediscpl', \
        ...
        self.PREDEFINED_HOSTS['polish']           = ['youtube','webstream','3filmy','efilmytv','alltubetv','ekinomaniak','ekinotv','cdapl','cdafilmy','iitvpl','ogladajto','govodtv','filmynadzis','tvpvod','ipla','tvnvod','vodpl', \
