# -*- coding: utf-8 -*-
# Last Modified: 04.07.2025 - WhiteWolf
###################################################
HOST_VERSION = "1.1"
###################################################
# LOCAL import
...
class Pannon(CBaseHostClass):
    ...
    def listMainMenu(self, cItem):
        ...
        MAIN_CAT_TAB = [{'category': 'list_items', 'title': 'Legfrissebb', 'url': 'https://pannonrtv.com/legfrissebb', 'desc': desc},
                        {'category': 'list_filters', 'title': 'Kategóriák', 'url': self.MAIN_URL, 'desc': desc, 'next': False},
