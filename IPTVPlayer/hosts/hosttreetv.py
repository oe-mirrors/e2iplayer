...
class TreeTv(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.defaultParams = {'header': self.HEADER, 'use_cookie': True, 'load_cookie': True, 'save_cookie': True, 'cookiefile': self.COOKIE_FILE, 'cookie_items': {'mycook': hex_md5(str(time.time()))}}
