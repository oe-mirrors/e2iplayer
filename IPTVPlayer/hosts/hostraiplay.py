...
class Raiplay(CBaseHostClass):
    ...
    def listOnDemandMain(self, cItem):
                    ...
                    if m:
                        if m[0] == "fiction":
                            params = MergeDicts(cItem, {
                                'category': 'ondemand_items',
                                'title': "Serie italiane",
                                'name': "Serie italiane",
                                'url': "/raiplay/tipologia/serieitaliane/index.json",
                                'icon': "https://www.rai.it/dl/img/2018/06/04/1528107006058_ico-fiction.png",
                                'sub-type': item["sub-type"]
                            })
                            if params["url"] not in seen_urls:
                                printDBG(str(params))
                                self.addDir(params)
                                seen_urls.add(params["url"])

                            params = MergeDicts(cItem, {
                                'category': 'ondemand_subhome',
                                'title': "Original",
                                'name': "Original",
                                'url': "/raiplay/tipologia/original/index.json",
                                'icon': "https://www.rai.it/dl/img/2018/06/04/1528107006058_ico-fiction.png",
                                'sub-type': item["sub-type"]
                            })
                            if params["url"] not in seen_urls:
                            ...
                            params = MergeDicts(cItem, {
                                'category': 'ondemand_items',
                                'title': "Serie internazionali",
                                'name': "Serie internazionali",
                                'url': "/raiplay/tipologia/serieinternazionali/index.json",
                                'icon': "https://www.rai.it/dl/img/2018/06/04/1528107006058_ico-fiction.png",
                                'sub-type': item["sub-type"]
                            })
                            if params["url"] not in seen_urls:
                            ...
                            params = MergeDicts(cItem, {
                                ...
                                'title': "Bambini",
                                'name': "Bambini",
                                'url': "/raiplay/tipologia/bambini/index.json",
                                'icon': icon,
                                'sub-type': item["sub-type"]
                            })
                            if params["url"] not in seen_urls:
                            ...
                            params = MergeDicts(cItem, {
                                ...
                                'title': "Teen",
                                'name': "Teen",
                                'url': "/raiplay/tipologia/teen/index.json",
                                'icon': icon,
                                'sub-type': item["sub-type"]
                            })
                            if params["url"] not in seen_urls:
        ...
        # aggiungo "Teatro e musica" fuori dal ciclo
        params = MergeDicts(cItem, {
            'category': 'ondemand_items',
            'title': "Teatro e musica",
            'name': "Teatro e musica",
            'url': "/raiplay/tipologia/musica-e-teatro/index.json",
            'icon': self.getThumbnailUrl("/dl/img/2018/06/04/1528115285089_ico-teatro.png"),
        ...
        # aggiungo "Documentari" fuori dal ciclo
        params = MergeDicts(cItem, {
            'category': 'ondemand_items',
            'title': "Documentari",
            'name': "Documentari",
            'url': "/raiplay/tipologia/documentari/index.json",
            'icon': self.getThumbnailUrl("/dl/img/2018/06/04/1528115285089_ico-documentari.png"),
            'sub-type': "RaiPlay Tipologia Page"
        })
        if params["url"] not in seen_urls:
            printDBG(str(params))
