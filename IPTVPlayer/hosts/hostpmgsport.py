...
class PmgSport(CBaseHostClass):
    ...
    def listMainMenu(self):
        ...
        for s in sport_h:
            ...
            title = html.parser.HTMLParser().unescape(title).encode('utf-8')
        ...
        for s in sports:
            ...
            for i in range(1, len(items)):
                ...
                title_s = html.parser.HTMLParser().unescape(title_s).encode('utf-8')
    ...
    def listSportItems(self, cItem):
        ...
        for i in items:
            ...
            title = html.parser.HTMLParser().unescape(title).encode('utf-8').strip()

            desc = re.findall("div class=\"entry-excerpt\">\n(.*?)</div>", i)[0]
            desc = html.parser.HTMLParser().unescape(desc).encode('utf-8').strip()
