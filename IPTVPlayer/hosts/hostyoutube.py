...
import os
import codecs
from Components.config import config, ConfigDirectory, getConfigListEntry, ConfigYesNo
...
def GetConfigList():
    ...
    optionList.append(getConfigListEntry(_("Include chapters in mkv"), config.plugins.iptvplayer.youtube_mkv_chapters))
    optionList.append(getConfigListEntry(_("Include Enigma2 cuts"), config.plugins.iptvplayer.youtube_enigma2_cuts))
...
class Youtube(CBaseHostClass):
    ...
    def __init__(self):
        ...
        self.DEFAULT_ICON_URL = "https://reklamadim.pl/youtube.png"
