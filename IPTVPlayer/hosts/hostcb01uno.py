...
def gettytul():
    return 'https://cb01net.buzz/'


class Cb01(CBaseHostClass):

    def __init__(self):
        CBaseHostClass.__init__(self, {'history': 'cb01.buzz', 'cookie': 'cb01.buzz.cookie'})
        ...
        self.MAIN_URL = 'https://cb01net.buzz/'
        self.DEFAULT_ICON_URL = 'https://cb01net.buzz/wp-content/uploads/2025/02/logo-cb01-it-com-film-streaming.png'
