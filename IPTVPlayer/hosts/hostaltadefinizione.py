...
def gettytul():
    return 'https://altadefinizionegratis.news/'


class Altadefinizione(CBaseHostClass):

    def __init__(self):
        CBaseHostClass.__init__(self, {'history': 'altadefinizione01.courses', 'cookie': 'altadefinizione01.courses.cookie'})
        ...
        self.MAIN_URL = 'https://altadefinizionegratis.news/'
        self.DEFAULT_ICON_URL = 'https://altadefinizionegratis.news/templates/Dark/img/logo.png'
