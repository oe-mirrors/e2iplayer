...
class cda(CBaseHostClass, CaptchaHelper):
    ...
    def __init__(self):
        ...
        self.MAIN_TAB = [{"category": "video", "title": "Filmy wideo", "url": ""}, {"category": "premium", "title": "CDA Premium", "url": self.getFullUrl("premium")}, {"category": "channels_cats", "title": "Kanały", "url": ""}] + self.searchItems()

        self.VIDEO_TAB = [{"category": "categories", "title": "Główna", "base_url": "video"}, {"category": "categories", "title": "Poczekalnia", "base_url": "video/poczekalnia"}]

        self.CATEGORIES_TAB = [{"url": "", "category": "category", "title": "--Wszystkie--"}, {"url": "/kat26", "category": "category", "title": "Krótkie filmy i animacje"}, {"url": "/kat24", "category": "category", "title": "Filmy Extremalne"}, {"url": "/kat27", "category": "category", "title": "Motoryzacja, wypadki"}, {"url": "/kat28", "category": "category", "title": "Muzyka"}, {"url": "/kat29", "category": "category", "title": "Prosto z Polski"}, {"url": "/kat30", "category": "category", "title": "Rozrywka"}, {"url": "/kat31", "category": "category", "title": "Sport"}, {"url": "/kat32", "category": "category", "title": "Śmieszne filmy"}, {"url": "/kat33", "category": "category", "title": "Różności"}, {"url": "/kat34", "category": "category", "title": "Życie studenckie"}]
        self.cacheFilters = {}
        self.filtersTab = []
        self.loggedIn = None
        self.login = ""
    ...
    def tryTologin(self):
        ...
        if None is self.loggedIn or self.login != config.plugins.iptvplayer.cda_login.value or self.password != config.plugins.iptvplayer.cda_password.value:
