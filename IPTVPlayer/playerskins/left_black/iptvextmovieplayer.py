    ...
    def __prepareSkin(self):
        ...
        if getDesktop(0).size().width() < 800:
            ...
            <screen name="IPTVExtMoviePlayer"    position="center,center" size="%d,%d" flags="wfNoBorder" backgroundColor="#FFFFFFFF" >
                    ...
                    <widget name="infoBarTitle"       noWrap="1" position="220,41"        size="1000,50"  zPosition="3" transparent="1" foregroundColor="white"     backgroundColor="#251f1f1f" font="HD_Thin;29" halign="left" valign="center"/>
            ...
            playbackBannerFile = "playback_banner_navy.png"
            skin = """
            <screen name="IPTVExtMoviePlayer"    position="center,center" size="%d,%d" flags="wfNoBorder" backgroundColor="#FFFFFFFF" >
                    ...
                    <widget name="bufferingCBar"      position="220,86"        size="840,7"     zPosition="4" pixmap="%s" transparent="1" borderWidth="1" borderColor="#888888" />
                    <widget name="bufferingBar"       position="220,86"        size="840,7"     zPosition="3" pixmap="%s" borderWidth="1" borderColor="#888888" />
                    <widget name="statusIcon"         position="125,50"        size="80,80"     zPosition="4"             transparent="1" alphatest="blend" />
                    <widget name="loopIcon"           position="60,80"       size="40,40"     zPosition="4"             transparent="1" alphatest="blend" />
        ...
        if self.clockFormat:
            clockFontSize = 24 if getDesktop(0).size().width() == 1920 else 36
            clockWidget = '<widget name="clockTime" noWrap="1" position="35,6" size="500,40" zPosition="3" transparent="1" foregroundColor="#b1b5bd" backgroundColor="#251f1f1f" font="Regular;%d" halign="left" valign="center" />' % clockFontSize
        else:
            clockWidget = ''
        ...
        skin =  skin % ( getDesktop(0).size().width(), 
                         ...
                         GetIPTVDMImgDir("playback_progress_l.png"),
