...
class IPTVExtMoviePlayer(Screen):
    ...
    def __prepareSkin(self):
        ...
        if getDesktop(0).size().width() < 800:
            ...
            playbackBannerFile = "playback_banner_l.png"
            skin = """
            <screen name="IPTVExtMoviePlayer"    position="center,center" size="%d,%d" flags="wfNoBorder" backgroundColor="#FFFFFFFF" >
        ...
        if self.clockFormat:
            ...
            clockWidget = '<widget name="clockTime" noWrap="1" position="25,6" size="500,40" zPosition="3" transparent="1" foregroundColor="#b1b5bd" backgroundColor="#251f1f1f" font="Regular;%d" halign="left" valign="center" />' % clockFontSize
        else:
            clockWidget = ''
